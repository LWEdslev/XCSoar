...
#include "net/wifi/WPASupplicant.hpp"
...
private:
  ...
  gcc_pure
  NetworkInfo *FindByBSSID(const TCHAR *bssid) noexcept;

  gcc_pure
  NetworkInfo *FindVisibleBySSID(const TCHAR *ssid) noexcept;
