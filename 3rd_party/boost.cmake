...
# elseif(${TOOLCHAIN} MATCHES "Eclipse")
#       set(_TOOLSET clang)
#       set(Boost_COMPILER "-clang")
else()
...
# variant=release 
# set(_BUILD_CMD ./b2 -j4 release toolset=msvc link=static runtime-link=shared threading=multi address-model=64 --layout=versioned --prefix=${BOOST_INSTALL_DIR} --build-dir=
...
# this compile definitions has to be defined in main CMakeLists, not here!
