...
#message(FATAL_ERROR post_3rdparty: "${${TARGET_CNAME}_TARGET} PROPERTIES IMPORTED_LOCATION  ${${TARGET_CNAME}_LIB}  GENERATED TRUE")
#message(FATAL_ERROR post_3rdparty: "${${TARGET_CNAME}_TARGET} PROPERTIES IMPORTED_LOCATION  ${_TARGET_LIBS}  GENERATED TRUE")
